...
# This is an attempt to get rid of the pattern that has the early years below median and later years above median.  Starting with adding rdm walk to the b2 model. Going to try some sort of ARIMAX
# Model ln scale: N2-N4 + forecast for each age----
