...
# Cook's D
if(b==1|b==2){
plot(y = dN3, x = 1:25, xlab = "Observation", ylab = "Cook's D") # should follow the line
}
```
...
# Cook's D
if(b==1){
plot(y = dN4, x = 1:25, xlab = "Observation", ylab = "Cook's D") # should follow the line
}
```
...
```{r}
if(b==1|b==2){
plot(jags.data$LD[3:23], resN3_mean[3:23], xlab = "Larval Density", ylab = "Pearson resids")
}
```
...
```{r}
if(b==1|b==2){
plot(jags.data$TI, resN3_mean, xlab = "Ice retreat", ylab = "Pearson resids")
}
```
...
```{r}
if(b==1){
plot(jags.data$LD[3:23], resN4_mean[3:23], xlab = "Larval Density", ylab = "Pearson resids")
}
```
...
```{r}
if(b==1){
plot(jags.data$TI, resN4_mean, xlab = "Ice retreat", ylab = "Pearson resids")
}
```
...
pg2 <- postPriors(df = g2$jags, df2 = g2$prior, df3 = g2$df_cred, limits, x_label=g2$x_label, priormean=g2$priormean, priorsd=g2$priorsd, by_bin = g2$bin_1)
