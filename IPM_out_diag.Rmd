...
# Cook's D
if (b == 10){
   plot(y = posa_df$posa2^2, x = N2xaxis, xlab = "Observation", ylab = "Cook's D")  
} else {
...
# Cook's D
if(b == 10){
 plot(y = posa_df$posa3^2, x = N2xaxis, xlab = "Observation", ylab = "Cook's D") # should follow the line
} else if(b==1|b==2){
